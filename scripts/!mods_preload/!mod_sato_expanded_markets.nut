            ...
            if (_id == "building.marketplace") {
                ...
                if (getBuilding("building.taxidermist") != null || getBuilding("building.taxidermist_oriental") != null) {
                    if (getCulture() == Const.World.Culture.Northern) {
                        _list.extend([
                            { R = 50, P = 1.0, S = ::SEM_NORTHERN_BEAST_PARTS_LOW[Math.rand(0, ::SEM_NORTHERN_BEAST_PARTS_LOW.len() - 1)] },
                            { R = 75, P = 1.0, S = ::SEM_NORTHERN_BEAST_PARTS_LOW[Math.rand(0, ::SEM_NORTHERN_BEAST_PARTS_LOW.len() - 1)] },
                            { R = 99, P = 1.0, S = ::SEM_NORTHERN_BEAST_PARTS_LOW[Math.rand(0, ::SEM_NORTHERN_BEAST_PARTS_LOW.len() - 1)] },
                            { R = 75, P = 1.1, S = ::SEM_NORTHERN_BEAST_PARTS_MED[Math.rand(0, ::SEM_NORTHERN_BEAST_PARTS_MED.len() - 1)] },
                            { R = 99, P = 1.1, S = ::SEM_NORTHERN_BEAST_PARTS_MED[Math.rand(0, ::SEM_NORTHERN_BEAST_PARTS_MED.len() - 1)] },
                        ...
                        _list.extend([
                            { R = 50, P = 1.0, S = ::SEM_MIDLAND_BEAST_PARTS_LOW[Math.rand(0, ::SEM_MIDLAND_BEAST_PARTS_LOW.len() - 1)] },
                            { R = 75, P = 1.0, S = ::SEM_MIDLAND_BEAST_PARTS_LOW[Math.rand(0, ::SEM_MIDLAND_BEAST_PARTS_LOW.len() - 1)] },
                            { R = 99, P = 1.0, S = ::SEM_MIDLAND_BEAST_PARTS_LOW[Math.rand(0, ::SEM_MIDLAND_BEAST_PARTS_LOW.len() - 1)] },
                            { R = 75, P = 1.1, S = ::SEM_MIDLAND_BEAST_PARTS_MED[Math.rand(0, ::SEM_MIDLAND_BEAST_PARTS_MED.len() - 1)] },
                            { R = 99, P = 1.1, S = ::SEM_MIDLAND_BEAST_PARTS_MED[Math.rand(0, ::SEM_MIDLAND_BEAST_PARTS_MED.len() - 1)] },
                            { R = 90, P = 1.2, S = ::SEM_MIDLAND_BEAST_PARTS_HIGH[Math.rand(0, ::SEM_MIDLAND_BEAST_PARTS_HIGH.len() - 1)] }
                        ]);
                    } else if (getCulture() == Const.World.Culture.Southern) {
                        _list.extend([
                            { R = 50, P = 1.0, S = ::SEM_SOUTHERN_BEAST_PARTS_LOW[Math.rand(0, ::SEM_SOUTHERN_BEAST_PARTS_LOW.len() - 1)] },
                            { R = 75, P = 1.0, S = ::SEM_SOUTHERN_BEAST_PARTS_LOW[Math.rand(0, ::SEM_SOUTHERN_BEAST_PARTS_LOW.len() - 1)] },
                            { R = 99, P = 1.0, S = ::SEM_SOUTHERN_BEAST_PARTS_LOW[Math.rand(0, ::SEM_SOUTHERN_BEAST_PARTS_LOW.len() - 1)] },
                            { R = 75, P = 1.1, S = ::SEM_SOUTHERN_BEAST_PARTS_MED[Math.rand(0, ::SEM_SOUTHERN_BEAST_PARTS_MED.len() - 1)] },
                            { R = 99, P = 1.1, S = ::SEM_SOUTHERN_BEAST_PARTS_MED[Math.rand(0, ::SEM_SOUTHERN_BEAST_PARTS_MED.len() - 1)] },
                            { R = 90, P = 1.2, S = ::SEM_SOUTHERN_BEAST_PARTS_HIGH[Math.rand(0, ::SEM_SOUTHERN_BEAST_PARTS_HIGH.len() - 1)] }
                        ]);
                    }
                }
                ...
                if (getCulture() == Const.World.Culture.Northern) {
                    if (Const.DLC.Wildmen) {
                        _list.extend([
                            { R = 75, P = 1.0, S = ::SEM_NORTHERN_WEAPONS[Math.rand(0, ::SEM_NORTHERN_WEAPONS.len() - 1)] },
                            { R = 75, P = 1.0, S = ::SEM_NORTHERN_ARMOR[Math.rand(0, ::SEM_NORTHERN_ARMOR.len() - 1)] },
                            { R = 80, P = 1.0, S = ::SEM_NORTHERN_ARMOR[Math.rand(0, ::SEM_NORTHERN_ARMOR.len() - 1)] },
                        ]);
                    } else {
                        _list.extend([
                            { R = 75, P = 1.0, S = ::SEM_MIDLAND_ARMOR[Math.rand(0, ::SEM_MIDLAND_ARMOR.len() - 1)] },
                            { R = 80, P = 1.0, S = ::SEM_MIDLAND_ARMOR[Math.rand(0, ::SEM_MIDLAND_ARMOR.len() - 1)] },
                        ]);
                    }
                } else if (getCulture() == Const.World.Culture.Neutral) {
                    _list.extend([
                    ...
                    _list.extend([
                        { R = 80, P = 1.0, S = ::SEM_SOUTHERN_WEAPONS[Math.rand(0, ::SEM_SOUTHERN_WEAPONS.len() - 1)] },
                        { R = 75, P = 1.0, S = ::SEM_SOUTHERN_ARMOR[Math.rand(0, ::SEM_SOUTHERN_ARMOR.len() - 1)] },
                        { R = 80, P = 1.0, S = ::SEM_SOUTHERN_ARMOR[Math.rand(0, ::SEM_SOUTHERN_ARMOR.len() - 1)] },
                    ]);
                }
            }
            onUpdateShopList( _id, _list );
